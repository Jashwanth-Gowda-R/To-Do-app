...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://postgres@localhost:5432/todo'
db = SQLAlchemy(app)
...
# # @app.route('/todos/create', methods=['POST'])
# # def create():
# #     description_by_user_input = request.form.get('description', '')
# #     todo = Todo(description=description_by_user_input)
# #     db.session.add(todo)
# #     db.session.commit()
# #     return redirect(url_for('index'))
#
